                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            int pos = user.indexOf("@"); //para separar los caracteres donde hayan @. crea dos zonas, 1 y 0.
                            ...
                            Toast.makeText(getApplicationContext(), "Credencial incorrectas", Toast.LENGTH_LONG).show();
                        }
                    }
                });
